  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        homeCategoryProduct.products!.isNotEmpty ?
        ConstrainedBox(constraints: const BoxConstraints(maxHeight: BouncingScrollSimulation.maxSpringTransferVelocity),
        ...
        : Padding(
            ...
            child: Center(
              child: TextButton.icon(
                ...
                icon: Icon(Icons.shopping_bag_outlined, color: Theme.of(context).primaryColor),
                label: Text('View Catalog', style: textRegular.copyWith(color: Theme.of(context).primaryColor)),
