...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> _loadData(bool reload) async {
    ...
    if(authController.isLoggedIn()){
      apiCalls.add(Provider.of<ProfileController>(Get.context!, listen: false).getUserInfo(Get.context!));
      apiCalls.add(Provider.of<WishListController>(Get.context!, listen: false).getWishList());
    }
  ...
  void initState() {
    ...
    // Flash deal data is now served by getHomeDataAggregation -> initFlashDealData
    _loadData(false);
  }
          ...
          child: CustomScrollView(controller: _scrollController, slivers: [
              ...
              SliverToBoxAdapter(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Selector<ProductController, List<dynamic>?>(
                      selector: (context, provider) => provider.featuredProductList,
                      builder: (context, featuredProductList,_) {
                        return  featuredProductList != null? featuredProductList.isNotEmpty ?
                        Stack(children: [
