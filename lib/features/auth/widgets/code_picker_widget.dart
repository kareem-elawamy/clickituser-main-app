    ...
    final item = await showDialog(
      ...
      builder: (context) => Center(
        child: Dialog(
          ...
          // Find this section in your showCodePickerWidgetDialog method
child: SelectionDialog(
  elements,
  favoriteElements,
  showCountryOnly: widget.showCountryOnly,
  ...
  hideHeaderText: false, // or true based on your preference
  headerAlignment: MainAxisAlignment.start,
  headerTextStyle: widget.dialogTextStyle ?? const TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
