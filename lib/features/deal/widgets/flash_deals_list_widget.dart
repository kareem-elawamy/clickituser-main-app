  ...
  Widget build(BuildContext context) {
    ...
    Consumer<FlashDealController>(
      builder: (context, flashDealController, child) {
        // null or empty flash deal — show a compact teaser card instead of infinite shimmer
        if (flashDealController.flashDeal == null || flashDealController.flashDealList.isEmpty) {
          return Padding(
              ...
              child: Container(
                ...
                child: Row(children: [
                  ...
                  Column(mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    const Text('Flash Sales', style: TextStyle(color: Colors.white,
                      fontSize: 16, fontWeight: FontWeight.bold)),
                    const SizedBox(height: 2),
                    Text('Stay tuned for lightning deals!',
