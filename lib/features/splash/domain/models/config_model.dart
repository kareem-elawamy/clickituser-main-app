class ConfigModel {
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    companyLogo = json['company_logo'] is Map ? json['company_logo']['key']?.toString() : json['company_logo']?.toString();
    companyCoverImage = json['company_cover_image'] is Map ? json['company_cover_image']['key']?.toString() : json['company_cover_image']?.toString();
    companyIcon = json['company_fav_icon'] is Map ? json['company_fav_icon']['key']?.toString() : json['company_fav_icon']?.toString();
    ...
    maintenanceMode = json['maintenance_mode'] is Map
        ? (json['maintenance_mode']['maintenance_status'] == 1)
