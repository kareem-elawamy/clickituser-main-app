      ...
      child : Padding(
        ...
        child: Container(clipBehavior: Clip.none, decoration: BoxDecoration(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              ConstrainedBox(
                constraints: const BoxConstraints(minHeight: 55, maxHeight: 80),
                  ...
                  Container(
                    ...
                    child: Stack(children: [
                      ...
                      (widget.sellerModel?.shop?.temporaryClose ?? false)
                          ? Center(child: Text(getTranslated('temporary_closed', context)!,
                              textAlign: TextAlign.center, maxLines: 1, overflow: TextOverflow.ellipsis,
                              style: textRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeLarge)))
                          : vacationIsOn
                              ? Center(child: Text(getTranslated('close_for_now', context)!,
                                  textAlign: TextAlign.center, maxLines: 1, overflow: TextOverflow.ellipsis,
                                  style: textRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeLarge)))
                              : const SizedBox(),
                    ]),
                  ...
                  Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Padding(
                        ...
                        child: Row(children: [
                          ...
                          Flexible(child: Text("${widget.sellerModel?.averageRating?.toStringAsFixed(1)} ",
                              maxLines: 1, overflow: TextOverflow.ellipsis,
                              style: textRegular.copyWith(fontSize: Dimensions.fontSizeSmall))),
                          Flexible(child: Text(" (${widget.sellerModel?.ratingCount ?? 0})",
                              maxLines: 1, overflow: TextOverflow.ellipsis,
              ...
              child: Row( children: [
                ...
                Expanded(child: Container(padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Flexible(child: Text(NumberFormat.compact().format(widget.sellerModel?.productCount??0),
                      maxLines: 1, overflow: TextOverflow.ellipsis,
                      style: textBold.copyWith(fontSize: Dimensions.fontSizeDefault, color:Theme.of(context).primaryColor))),
                    const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                    Flexible(child: Text("${getTranslated('products', context)}",
                      maxLines: 1, overflow: TextOverflow.ellipsis,
