...
class OrderModel {
  ...
  OrderModel.fromJson(Map<String, dynamic> json) {
    totalSize = json['total_size'];
    // 🛠️ التعديل هنا: تحويل القيم إلى نصوص بأمان لتجنب الانهيار
    limit = json['limit'] != null ? json['limit'].toString() : null;
    offset = json['offset'] != null ? json['offset'].toString() : null;
...
class Orders {
  ...
  Orders.fromJson(Map<String, dynamic> json) {
    ...
    customerId = json['customer_id'];
    if(json['temporary_close'] != null){
      isGuest = int.tryParse(json['temporary_close'].toString()); // استخدام tryParse أأمن
    }else{
      isGuest = 0;
    }
    ...
    orderStatus = json['order_status'];
    paymentMethod = json['payment_method'];
    transactionRef = json['transaction_ref']?.toString(); // تعديل احترازي
    paymentBy = json['payment_by'];
    paymentNote = json['payment_note'];
    orderAmount = json['order_amount'] != null ? double.parse(json['order_amount'].toString()) : 0.0;
    ...
    isShippingFree = json['is_shipping_free'] ?? false;
    orderGroupId = json['order_group_id']?.toString(); // تعديل احترازي
    ...
    billingAddressData = json['billing_address_data'] != null ? BillingAddressData.fromJson(json['billing_address_data']) : null;
    orderType = json['order_type'];
    extraDiscount = json['extra_discount'] != null ? double.parse(json['extra_discount'].toString()) : 0.0;
    extraDiscountType = json['extra_discount_type'];
    freeDeliveryBearer = json['free_delivery_bearer'];
    shippingType = json['shipping_type'];
    deliveryType = json['delivery_type'];
    deliveryServiceName = json['delivery_service_name'];
    thirdPartyDeliveryTrackingId = json['third_party_delivery_tracking_id']?.toString();
